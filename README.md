...
Bhavcopy_V2.1.exe is supporting data download from 01st January 2020 Till today. Its very easy to perform download. Required to download "Bhavcopy_V2.0.exe" on pc after executing this file
File will ask for entering bhavcopy download dates. 


Application running requirements:-
1)	Windows computer.
2)	Disk free space of 200 MB.
